...
def test_pipeline_cnv():
    ...
    vcf_file = "tests/full_data/clinvar_GRCh38_2020-11.vcf"
    clinvarome = "tests/full_data/clinvarome_20201031.tsv"
    compare_gene = "tests/full_data/compare-gene_total.tsv"
    compare_variant = "tests/full_data/compare-variant_total.tsv"
    outdir = "tests/out"
    assert (
